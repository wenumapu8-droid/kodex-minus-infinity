...
> Historical snapshot preserved verbatim for provenance. This decision was current on 2026-08-06 and was later superseded for V1 implementation by `ADR-0011-SEVEN-SCENE-CORRIDOR-V1.md`.
...
This historical decision authorized architecture, registry and implementation work at the time. It does not authorize current production deployment. `APROBAR DEPLOY` remains required.
